...
func TestHealthServer(t *testing.T) {
	...
	t.Run("initially unavailable", func(t *testing.T) {
		eventuallyServingStatus(t, hs.svc, healthpb.HealthCheckResponse_NOT_SERVING)
	})
	t.Run("updated available", func(t *testing.T) {
		...
		eventuallyServingStatus(t, hs.svc, healthpb.HealthCheckResponse_SERVING)
	})
...
func eventuallyServingStatus(t *testing.T, svc healthpb.HealthServer, status healthpb.HealthCheckResponse_ServingStatus) {
	t.Helper()
