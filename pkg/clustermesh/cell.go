...
var Cell = cell.Module(
	...
	cell.ProvidePrivate(func(mgr nodemanager.NodeManager) (nodeStore.NodeManager, kvstore.ClusterSizeDependentIntervalFunc) {
		return mgr, mgr.ClusterSizeDependentInterval
	}),
